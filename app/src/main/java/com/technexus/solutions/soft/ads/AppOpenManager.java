...
import com.technexus.solutions.soft.MyApp;
import com.technexus.solutions.soft.translator_activities.SplashActivity;
...
public class AppOpenManager implements Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    public AppOpenManager(MyApp wqnjMyApplication) {
    ...
    public static void fetchAd() {
        ...
        Log.e("fasdfadf", "fetchAd: "+ SharePrefs.getInstance(wqnjMyApplication).getString(Utils.OPEN_AD_ID) );
        AppOpenAd.load(
                wqnjMyApplication, SharePrefs.getInstance(wqnjMyApplication).getString(Utils.OPEN_AD_ID), builder.build(),
    ...
    public static void showAdIfAvailable() {
        ...
        if (!isShowingAd && isAdAvailable()) {
            ...
            if (!SharePrefs.getInstance(wqnjMyApplication).getBoolean(Utils.IS_SUBSCRIBE) && !(currentActivity instanceof SplashActivity)) {
